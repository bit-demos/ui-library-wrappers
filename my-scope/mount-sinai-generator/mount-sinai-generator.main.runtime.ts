...
import { MountSinaiGeneratorAspect } from './mount-sinai-generator.aspect';

export class MountSinaiGeneratorMain {
  static slots = [];
...
`,
    ...
    return new MountSinaiGeneratorMain();
  }
}

MountSinaiGeneratorAspect.addRuntime(MountSinaiGeneratorMain);
